...
Vagrant.configure(2) do |config|
  ...
  config.vm.synced_folder ".", "/home/vagrant/inkscape"
...
./configure
make
echo "Inkscape built successfully."
echo "Login to the VM with user vagrant, password vagrant"
echo "Then you will find the executable in /home/vagrant/inkscape/src"
  SHELL
